...
use Carbon\Carbon;
use Flits\Bitespeed\API\SendMessage;
...
class BitespeedTest extends TestCase {
    ...
    public function UploadAPI($updatedCustomer, $extraData, $event_name) {
        ...
        $requestData = '{
            "d": [
                {
                    "channelId":"",
                    "recipient":"' . $updatedCustomer['phone'] . '",
        ...
        $bitespeedTrack = new SendMessage($this->getHeaders());
        $response = $bitespeedTrack->POST($requestData);
